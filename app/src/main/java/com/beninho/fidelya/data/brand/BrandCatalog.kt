...
val BRAND_CATALOG: List<Brand> = listOf(
    ...
    Brand("Magasins U", "Carte U", "Grande distribution", R.drawable.brand_u, "#876266"),
    Brand("Chlorophylle Coop", "Carte chlorophylle", "Magasin Bio", R.drawable.brand_chlorophylle, "#B7562E"),
    ...
    Brand("Decathlon", "Carte Decathlon", "Culture & loisirs", R.drawable.brand_decathlon, "#39524B"),
    Brand("Intersport", "Team INTERSPORT", "Culture & loisirs", R.drawable.brand_intersport, "#6E2C5B"),
    ...
    Brand("Jardiland", "Carte jardiland", "Maison", R.drawable.brand_jardiland, "#FC4209"),
